program mpi_ising2d_periodic_dl_local_probtab_globalpar_int8
  use, intrinsic :: iso_fortran_env
  use mpi
  use gf2xe
  use msmt19937
  use ising2d_periodic_dual_lattice_locali_probtab_globpar_int8_m
...
end program mpi_ising2d_periodic_dl_local_probtab_globalpar_int8
