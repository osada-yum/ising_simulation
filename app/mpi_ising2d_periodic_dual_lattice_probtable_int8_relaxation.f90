program mpi_ising2d_periodic_dual_lattice_probtable_int8_relaxation
  use, intrinsic :: iso_fortran_env
  use mpi
  use gf2xe
  use msmt19937
  use ising2d_periodic_dual_lattice_probtable_int8_m
...
end program mpi_ising2d_periodic_dual_lattice_probtable_int8_relaxation
