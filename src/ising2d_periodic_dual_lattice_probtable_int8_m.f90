module ising2d_periodic_dual_lattice_probtable_int8_m
  use, intrinsic :: iso_fortran_env
  use msmt19937
  implicit none
  private
  character(len=*), parameter :: version = "dual_lattice_probtable_int8"
...
end module ising2d_periodic_dual_lattice_probtable_int8_m
