module ising2d_periodic_dual_lattice_locality_probtable_m
...
contains
  ...
  impure subroutine update_metropolis()
    ...
    do y = 3, ny / 2
       do x = 1, nx
          call local_flip_even(ising2d_even, ising2d_odd, x, y)
          call local_flip_odd(ising2d_odd, ising2d_even, x, y - 1)
       end do
    end do

    !> odd y == ny / 2.
    do x = 1, nx
       call local_flip_odd(ising2d_odd, ising2d_even, x, ny / 2)
    end do
    !> odd y == 1.
    do x = 1, nx
       call local_flip_odd(ising2d_odd, ising2d_even, x, 1_int64)
    end do
...
end module ising2d_periodic_dual_lattice_locality_probtable_m
